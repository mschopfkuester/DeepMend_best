...
def reconstruct(
    ...
    tb_logger = torch.utils.tensorboard.writer.SummaryWriter(log_dir="Rec_Jars")
    ...
    for e in range(num_iterations):
        ...
        if lambda_ner != 0.0:
            ...
            tb_logger.add_scalar("ner_loss", ner_loss.item(), e)
        tb_logger.add_scalar("rec_mean", r_x.mean().item(), e)
