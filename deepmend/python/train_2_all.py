...
for k,id in enumerate(test_dict[:]):
    ...
    shutil.copy(os.path.join(path_deepmend,experiment_dir,'Reconstructions','ours_@inference','Meshes','0_0_.obj'),os.path.join(path_deepmend,experiment_dir,'Reconstructions_lr','{}_0_.obj'.format(k)))
    shutil.copy(os.path.join(path_deepmend,experiment_dir,'Reconstructions','ours_@inference','Meshes','0_1_.obj'),os.path.join(path_deepmend,experiment_dir,'Reconstructions_lr','{}_1_.obj'.format(k)))
    shutil.copy(os.path.join(path_deepmend,experiment_dir,'Reconstructions','ours_@inference','Meshes','0_2_.obj'),os.path.join(path_deepmend,experiment_dir,'Reconstructions_lr','{}_2_.obj'.format(k)))
