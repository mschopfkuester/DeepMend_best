...
def create_new_dataset(datadir_old,datadir_new,path_recon_obj,path_train_test_file):
    ...
    f=open(path_train_test_file)
    #os.path.join(datadir_old,'split_original','mugs_split.json')
...
if __name__ == "__main__":
    ...
    arg_parser_dataset.add_argument(
        "--path_train_test_file",
        default="/home/michael/Projects/test_shapeNet/ShapeNet/ShapeNetCore.v2/jars_split.json",
        help="Path to reconstructed objects",
    )    
    ...
    create_new_dataset(args.datadir_old,args.datadir_new,args.path_recon_obj,args.path_train_test_file)
