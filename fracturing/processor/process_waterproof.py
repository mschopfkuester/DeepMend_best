...
import pyrender as librender

try:
    import cyfusion.pyx as libfusion
    from libfusiongpu.cyfusion import tsdf_gpu as compute_tsdf
except (ImportError, OSError):
    logging.debug("Not able to import GPU libfusion, falling back to CPU.")
    #import cyfusion as libfusion
    #from cyfusion import tsdf_cpu as compute_tsdf
